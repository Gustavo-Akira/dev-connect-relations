...
func (r *Neo4jCityRepository) CreateCity(ctx context.Context, city domain.City) (domain.City, error) {
...
func (r *Neo4jCityRepository) GetCityByFullName(ctx context.Context, fullName string) (*domain.City, error) {
	params := map[string]any{
		"full_name": fullName,
	}
